          ...
          <div className="wrap_product_detail">
            ...
            <div>
              ...
              <p>
                ...
                개설된 프로그램입니다.
                {/* <br />
                6회 세션이후에도, 한달에 한 번씩 그룹상담에 무료 초대되어,
                지속적인 도움을 드리게 됩니다.
                <br />
                단순히 힘듬을 넘어 스스로의 긍정적 발전을 지속하고 싶은 분들에게
                추천되는 프로그램입니다. */}
              </p>
              <p>
                Reborn I : 심층상담을 포함한 훨씬 다양한 프로그램들을 통해
                ...
                있습니다.
                {/* <br />
                총 8회 세션 이후에도, 한달에 한 번씩, 그룹상담 및 코칭 프로그램에 초대되어
                자기 자신에 대한 발전을 거듭할 수 있는 프로그램입니다. */}
              </p>
              <p>
              ...
              <p>
                ...
                해가며, "빛나는 존재", "다른 사람의 잃어버린 빛"을 찾아줄 수
                있는 존재로써 성장을 할 수 있는 프로그램입니다.
                {/* <br />
                총 8회 세션 이후에도, 한달에 한 번씩, 그룹상담 및 코칭 프로그램에 초대되어
                자기 자신에 대한 발전을 거듭할 수 있는 프로그램입니다. */}
              </p>
              ...
              <p>
                저희는 단순하게 '상담'을 판매하는 곳이 아닌, 내담자들의 행복을
                만들어드리며, 그에 맞는 진단과 해결을 위해 일을 하고 있습니다.
                <br />
                <br />
                실질적으로 진단이나 상담이 필요없거나 저희와 맞지 않는 분들은
                처음부터 '진단이 필요없으시다거나 저희와 맞지 않을 것' 이라고
                말씀드릴 것입니다.
                <br />
