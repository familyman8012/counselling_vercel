                ...
                <div className="col-sm-6 col-md-6 col-lg-6">
                  <div className="about-us-content-01">
                    ...
                    <div className="about-us-text-01">
                      <p>
                        스트레스, 우울, 불안, 가족관계, 부부, 연인관계 등,
                        여러가지 이유로 마음이 힘들어질 때가
                        있습니다.&#39;진정한 행복&#39;을 이끄는
                        마인드케어센터에서는 누구나 행복을 배울 수 있음에 대한
                        과학적 근거와 데이터에 기반한 긍정심리학을 바탕으로한
                        심리상담을 제공하고 있습니다.
                        <br />
                        혼자서 이겨내면 되겠지라고 힘들어하다 혼자서는 도무지
                        힘들어 전문적인 심리상담을 원한다면 마인드케어센터가
                        함께 하겠습니다.
                        <br />
                        내담자가 행복해질때까지 마인드케어센터가 함께
                        하겠습니다.
                      </p>
                    </div>
                ...
                <div className="col-lg-12 text-center">
                  ...
                  <div className="about-us-text-02">
                    <p>
                      ...
                      마인드케어센터는 모든 내담자 분들의 어려움에 가장 효과적인
                      맞춤형 상담 및 코칭을 통해 문제를 해결해나가고 있습니다.
                    </p>
                  </div>
                </div>
              </div>
              <div className="row">
                ...
                <div className="col-sm-4 col-md-4 col-lg-4">
                  <div className="trust-us-01">
                    ...
                    <div className="trust-us-01__text">
                      <p>
                        자칫 비슷한 사례 위주로 이해하고 진행되는 관행에서
                        벗어나 모든 내담자들의 사연을 깊이 있게 듣고 깊이 있게
                        이해하며, 그에 맞춰 상담이 이루어집니다.
                      </p>
                    </div>
                  </div>
                </div>
